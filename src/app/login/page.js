...
<div className='px-6'>
    ...
    <input  placeholder='Mobile Number' className='py-3 px-3 my-5 focus:outline-blue-400 placeholder:text-black placeholder:font-semibold rounded-md border-2 border-black w-full' onChange = {(e)=>{
        console.log(e.target.value);
        setUsername(e.target.value)
    }}/>
    

    <input  placeholder='Password' className='py-3 px-3 focus:outline-blue-400 mb-5 placeholder:text-black placeholder:font-semibold rounded-md border-2 border-black w-full' onChange = {(e)=>{
        console.log(e.target.value);
...
<button className='py-3 font-semibold rounded-md text-white bg-blue-400 w-full' onClick = {()=>{
